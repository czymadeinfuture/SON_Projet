...
class mydsp : public dsp {
 ...
 public:
	...
	#define FAUST_FILE_NAME "playerwithslider.dsp"
	...
	FAUST_ADDHORIZONTALSLIDER("Compressor Ratio", fHslider5, 0.5f, 0.1f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("Compressor Threshold", fHslider0, 0.5f, 0.1f, 1.0f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("LFO Depth", fHslider2, 0.001f, 0.0f, 5.0f, 0.0001f);
	FAUST_ADDHORIZONTALSLIDER("LFO Frequency", fHslider1, 0.5f, 0.1f, 1e+01f, 0.01f);
	FAUST_ADDHORIZONTALSLIDER("LPF Cutoff Frequency", fHslider4, 5e+03f, 1e+03f, 2e+04f, 1e+02f);
	FAUST_ADDHORIZONTALSLIDER("Noise Level", fHslider3, 0.02f, 0.0f, 0.1f, 0.001f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Compressor_Ratio, "Compressor Ratio", fHslider5, 0.5f, 0.1f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, Compressor_Threshold, "Compressor Threshold", fHslider0, 0.5f, 0.1f, 1.0f, 0.01f) \
		p(HORIZONTALSLIDER, LFO_Depth, "LFO Depth", fHslider2, 0.001f, 0.0f, 5.0f, 0.0001f) \
		p(HORIZONTALSLIDER, LFO_Frequency, "LFO Frequency", fHslider1, 0.5f, 0.1f, 1e+01f, 0.01f) \
		p(HORIZONTALSLIDER, LPF_Cutoff_Frequency, "LPF Cutoff Frequency", fHslider4, 5e+03f, 1e+03f, 2e+04f, 1e+02f) \
		p(HORIZONTALSLIDER, Noise_Level, "Noise Level", fHslider3, 0.02f, 0.0f, 0.1f, 0.001f) \
...
playerwithslider::playerwithslider() : AudioStream(FAUST_INPUTS, new audio_block_t*[FAUST_INPUTS])
{
#ifdef NVOICES
    int nvoices = NVOICES;
...
playerwithslider::~playerwithslider()
{
    delete fDSP;
    delete fUI;
    for (int i = 0; i < fDSP->getNumInputs(); i++) {
...
void playerwithslider::updateImp(void)
{
#if MIDICTRL
...
void playerwithslider::update(void) { updateImp<FAUST_INPUTS, FAUST_OUTPUTS>(); }

void playerwithslider::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

float playerwithslider::getParamValue(const std::string& path)
{
